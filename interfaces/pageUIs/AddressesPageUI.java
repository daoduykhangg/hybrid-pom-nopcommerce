...
public class AddressesPageUI {
	...
	public static final String STATE_PROVINCE_DROPDOWN = "//select[@id='Address_StateProvinceId']";
	...
	public static final String FULL_NAME = "//li[@class='name']";
	public static final String EMAIL = "//li[@class='email']";
	public static final String PHONE_NUMBER = "//li[@class='phone']";
	public static final String FAX_NUMBER = "//li[@class='fax']";
