...
public class User_05_Sort_Product_By_Name_And_Price_BrowserStack extends AbstractTest {
	WebDriver driver;

	@Parameters({ "url", "os", "os_version", "browser", "browser_version"})
	@BeforeTest
	public void beforeTest(String url, String osName, String osVersion, String browserName, String browserVersion) {
