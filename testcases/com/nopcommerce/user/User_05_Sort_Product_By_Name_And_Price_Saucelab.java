...
public class User_05_Sort_Product_By_Name_And_Price_Saucelab extends AbstractTest {
	WebDriver driver;

	@Parameters({ "url", "platform", "browser", "browser_version"})
	@BeforeTest
	public void beforeTest(String url, String platform, String browserName, String browserVersion) {
		driver = getBrowserDriverOnSaucelab(url, platform, browserName, browserVersion);
