...
public class Level_20_Register_Login_Manage_Data_I_Out_Class extends AbstractTest {
	WebDriver driver;
	...
	public void TC_02_Register() {
		...
		log.info("Register - Step 03: Input data to 'Firstname' textbox with value:" + UserData.Register.FIRST_NAME);
		registerPage.inputToTextboxByID(driver, "FirstName", UserData.Register.FIRST_NAME);

		log.info("Register - Step 04: Input data to 'LastName' textbox with value:" + UserData.Register.LAST_NAME);
		...
		log.info("Register - Step 08: Input to 'Email' textbox with value:" + UserData.PRE_EMAIL_ADDRESS + randomNum + "@gmail.com");
		registerPage.inputToTextboxByID(driver, "Email", UserData.PRE_EMAIL_ADDRESS + randomNum + "@gmail.com");

		log.info("Register - Step 09: Input data to 'Company' textbox");
		registerPage.inputToTextboxByID(driver, "Company", UserData.Register.COMPANY);

		log.info("Register - Step 10: Input to 'Password' textbox with value:" + UserData.PASSWORD);
		registerPage.inputToTextboxByID(driver, "Password", UserData.PASSWORD);
		registerPage.inputToTextboxByID(driver, "ConfirmPassword", UserData.PASSWORD);
	...
	public void TC_03_Login() {
		...
		log.info("Login - Step 02: Input to 'Email' textbox with value: " + UserData.PRE_EMAIL_ADDRESS + randomNum + "@gmail.com");
		loginPage.inputToTextboxByID(driver, "Email", UserData.PRE_EMAIL_ADDRESS + randomNum + "@gmail.com");

		log.info("Login - Step 03: Input to 'Password' textbox with value: " + UserData.PASSWORD);
		loginPage.inputToTextboxByID(driver, "Password", UserData.PASSWORD);
