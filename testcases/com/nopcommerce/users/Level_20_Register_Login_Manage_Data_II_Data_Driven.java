...
import com.nopcommerce.data.UserDataModel;
...
public class Level_20_Register_Login_Manage_Data_II_Data_Driven extends AbstractTest {
	WebDriver driver;
	...
	public void beforeTest(String browserName) {
		...
		userData = UserDataModel.getValue(GlobalConstants.ROOT_FOLDER + "\\testdata\\com\\nopcommerce\\data\\UserData.json");
	}
	...
	public void TC_02_Register() {
		...
		log.info("Register - Step 08: Input to 'Email' textbox with value:" + userData.getEmail() + randomNum + "@gmail.com");
		registerPage.inputToTextboxByID(driver, "Email", userData.getEmail() + randomNum + "@gmail.com");

		log.info("Register - Step 09: Input data to 'Company' textbox");
		registerPage.inputToTextboxByID(driver, "Company", userData.getCompany());
	...
	public void TC_03_Login() {
		...
		log.info("Login - Step 02: Input to 'Email' textbox with value: " + userData.getEmail() + randomNum + "@gmail.com");
		loginPage.inputToTextboxByID(driver, "Email", userData.getEmail() + randomNum + "@gmail.com");
